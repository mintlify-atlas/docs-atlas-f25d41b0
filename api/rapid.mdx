...
<ParamField path="filter" type="TextureFilterMode" required>
...
<ParamField path="antialias" type="boolean" required>
...
<ParamField path="customShader" type="GLShader | CustomGlShader">
