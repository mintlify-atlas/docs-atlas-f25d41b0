---
title: "ParticleEmitter and Particle System API Reference"
sidebarTitle: "ParticleEmitter"
description: "Complete API reference for ParticleEmitter and related interfaces: emit shapes, animated attributes, start/end value ranges, damping, and world/local space."
---
...
Describes an animated value for a single particle attribute. `T` may be `number`, `Vec2`, or `Color`.
