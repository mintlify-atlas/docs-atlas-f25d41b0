---
title: "TextTexture — Styled Text Rendering via Canvas 2D"
sidebarTitle: "TextTexture"
description: "API reference for TextTexture: render styled, multi-line text to a GPU texture with live updates, DPR-aware scaling, and Canvas 2D font control."
---
...
<ParamField path="text" type="string">
  ...
  The value can be updated at any time via the `text` setter.
</ParamField>

All fields from [`ITextStyle`](#itextstyle) (font, fill, stroke, align,
baseline) and [`ITextureOptions`](/api/texture-manager#itextureoptions)
