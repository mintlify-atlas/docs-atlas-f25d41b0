---
title: "Rapid Renderer: Configuration and Lifecycle"
...
The WebGL backbuffer is sized at `physicsWidth × physicsHeight` (logical size multiplied by the device pixel ratio). The canvas CSS size stays at the logical dimensions. Rotated sprites, lines, and geometry are rasterized at the full display resolution — ideal for games targeting HD and Retina displays.
