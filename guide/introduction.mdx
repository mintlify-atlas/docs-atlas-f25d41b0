...
<CardGroup cols={2}>
  <Card title="Instanced Sprites" icon="images">
  ...
  <Card title="Transform Stack" icon="layer-group">
  ...
  <Card title="Render Textures" icon="square">
  ...
  <Card title="Custom GLSL Shaders" icon="code">
  ...
  <Card title="Text Rendering" icon="text-size">
  ...
  <Card title="Blend Modes" icon="wand-magic-sparkles">
